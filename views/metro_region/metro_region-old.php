...
<head>
  ...
  <title>Вызвать <?= $content['variable_2'] ?> на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?> недорого, низкие цены на услуги 👍. Заказ эвакуации авто на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?> круглосуточно</title>
  <meta name="description" content="Предлагаем услуги <?= $content['variable_4'] ?> на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?> по доступным ценам, работаем круглосуточно. Подача эвакуатора на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?> от 30 минут.">
    ...
    <div class="container container_main_page">
        ...
        <div>
            <h1>
                ...
                <span class="first-screen__slogan">на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?></span>
        ...
        <div class="first-screen__address">
            ...
            <p class="fz14"><?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_im_p']?></p>
        </div>
    </div>
...
<!--what-we-offer-->
<?php include(ROOT.'/views/module3/what-we-offer-metro.php');?>
<!--what-we-offer END-->
...
<!--cargo-->
<?php include(ROOT.'/views/module3/cargo-metro.php');?>
<!--cargo END-->
...
<!-- how-we-work -->
<?php include(ROOT.'/views/module3/how-we-work-metro.php');?>
<!-- section END -->

<!-- examples -->
<?php include(ROOT.'/views/module3/examples-metro.php');?>
<!-- examples END -->

<!-- only-us -->
<?php include(ROOT.'/views/module3/only-us-metro.php');?>
<!-- only-us END -->
...
//                ?>
<!--                --><?php //if (($page[0] == $_SESSION['domen']) and ($page[1] == $_SESSION['metro_region'])) { ?>
<!---->
...
<!--                                    </div>-->
<!--                                </div>-->
<!--                                <p class="reviews__item-text">Я заказывал такелаж с погрузчиком, притом работу надо было выполнить срочно, буквально в течение нескольких часов. Услугами доволен: организовали все очень быстро, приехали без опозданий, работали тоже без лишних задержек. В итоге успели закончить вовремя – спасибо за это!</p>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                --><?php //} ?>
      ...
      <div class="slick-slider reviews__slider" id="reviews__slider">
        <div class="reviews__item ">
          <div class="flex_between">
            <div class="reviews__item-img">
              <picture>
                <source srcset="/img/otz/m5.jpg" type="image/webp">
        ...
        <div class="reviews__item ">
          <div class="flex_between">
            <div class="reviews__item-img">
              <picture>
                <source srcset="/img/otz/w2.jpg" type="image/webp">
                <img src="/img/otz/w2.jpg" alt="">
              </picture>
            </div>
            <div class="reviews__item-cont">
              ...
              <p class="reviews__item-text">Заказывала эвакуатор заранее, с вечера на утро. Нужно было аккуратно доставить KIA Ceed в автосервис на <?=$content['metro_region'][$_SESSION['metro_region']]['metro_region_predl_p']?>. Машину прислали четко ко времени, даже на 5 минут раньше. Что очень понравилось – это цена. Я звонила в несколько компаний, и тут оказалось существенно дешевле. Моя рекомендация.</p>
            </div>
          </div>
        </div>
        ...
        <div class="reviews__item ">
          <div class="flex_between">
            <div class="reviews__item-img">
              <picture>
                <source srcset="/img/otz/m2.jpg" type="image/webp">
...
<!-- nicely -->
<?php include(ROOT.'/views/module3/nicely-links-metro.php');?>
<!-- nicely END -->
