...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область по низким ценам, круглосуточно - <?= $content['brand'] ?></title>
