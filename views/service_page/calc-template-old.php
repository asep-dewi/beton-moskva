...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?> на доставку бетона в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область по низким ценам, круглосуточно.</title>
...
<body>
  <div class="wrap">
    ...
    <style>
      ...
      .tabs2__line li:first-child,
      .tabs2__line li:nth-child(2),
      .tabs2__line li:nth-child(3) {
        width: 200px;
        margin-right: 10px;
        padding: 5px;
      }
      ...
      .calc1__list li:first-child,
      .calc1__list li:nth-child(2),
      .calc1__list li:nth-child(3) {
        width: 210px;
      }
          ...
          <div class="calc1__content">
                    ...
                    <div class="tabs2__content-inner">
                      ...
                      <ul class="tabs2__line">
                        ...
                        <li>
                          <div class="number">
                            <button class="number-minus" type="button" onclick="this.nextElementSibling.stepDown(); this.nextElementSibling.onchange();">-</button>
                            <input type="number" class="num" min="0" max="9999" data-num="1" data-price="3099" value="0">
                            <button class="number-plus" type="button" onclick="this.previousElementSibling.stepUp(); this.previousElementSibling.onchange();">+</button>
                          </div>
            ...
            <div class="calc1__result">
              <div class="calc1__result-item">
                <span>Объём:</span> <span id="calc-weight">0</span> <span> м3</span </div>
                ...
                <div class="alc1__result-item">
                  <span>Итого:</span> <span id="calc-total">0</span> <span> ₽</span </div>
                </div>
