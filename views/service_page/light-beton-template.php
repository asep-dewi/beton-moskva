        ...
        <div class="cards-b__wrapper">
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['keramzitobeton']['B7.5B100']['name'] ?></div>
              <div class="cards-b__title">Легкий бетон (керамзит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['keramzitobeton']['B7.5B100']['price'] ?> р./м³</span></div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['keramzitobeton']['B12.5M150']['name'] ?></div>
              <div class="cards-b__title">Легкий бетон (керамзит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['keramzitobeton']['B12.5M150']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['keramzitobeton']['B15M200']['name'] ?></div>
              <div class="cards-b__title">Легкий бетон (керамзит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['keramzitobeton']['B15M200']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['keramzitobeton']['B20M250']['name'] ?></div>
              <div class="cards-b__title">Легкий бетон (керамзит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['keramzitobeton']['B20M250']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['keramzitobeton']['B22.5M300']['name'] ?></div>
              <div class="cards-b__title">Легкий бетон (керамзит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['keramzitobeton']['B22.5M300']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
