...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?> бетона в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область по низким ценам, круглосуточно - <?= $content['brand'] ?></title>
