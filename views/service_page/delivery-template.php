...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?> бетона в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область недорого, круглосуточно - <?= $content['brand'] ?></title>
  ...
  <div class="wrap">
    ...
    <section class="title deli-block" style="background-image: url(/img/title_delivery.jpg);">
      <div class="container">
        ...
        <h1><?= $content['service'][$_SESSION['service']]['service_1'] ?> бетона в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?></h1>
        <div class="row">
          <div class="col-md-6">
    ...
    <section class="block block__general-price">
      <div class="container">
        <ul class="tabs mnonm">
          <li class="tabs__item">
            <span class="tabs__link is-active">Москва</span>
            <div class="tabs__cnt">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="textInput" id="" placeholder="Напишите что-нибудь" data-parsley-type="digits" required="">

                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 price-rass">
                  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6 pras-1">
                    0 - 5 км.
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 pras-2">
                    300 руб.
                  </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 price-rass">
                  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6 pras-1">
                    5 - 10 км. (включительно)
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 pras-2">
                    350 руб.
                  </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 tab-right-side">
                <section class="block block__map">
                  <div id="map"></div>
                  <div class="container">
                    <div class="block__map__frame bmf2">
                      <p>Москва, Ленинградский проспект, 80</p>
                      <p>Расстояние: 10 км, Стоимость: 350 руб.</p>
                    </div>
                  </div>
                </section>
              </div>
          ...
          <li class="tabs__item">
            <span class="tabs__link">Подмосковье</span>
            <div class="tabs__cnt">
              <p>В зависимости от используемых пропорций добавок, качество и прочность бетона будут различными. Качество нашей продукции соответствтует ГОСТ 7473-94 "Смеси бетонные".</p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <section class="block delivery-terms">
      <div class="container">
        <h2 class="mb10">Условия доставки</h2>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-12">
            <a href="/цены/" class="btn mt15">посмотреть цены</a>
          </div>
        </div>
      </div>
    </section>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="select-block">
                      <select class="js-choice" name="select_marka" id="validation-form__select" data-search="true" data-placeholder="Марка прочности бетона" required>
                        ...
                        <!--                      <option value="В7,5 П4">В7,5 П4</option>-->
                        <!--                      <option value="В12,5 П4">В12,5 П4</option>-->
                        <!--                      <option value="В15 П4">В15 П4</option>-->
                        <!--                      <option value="В20 П4">В20 П4</option>-->
                        <!--                      <option value="В22,5 П4">В22,5 П4</option>-->
                        <!--                      <option value="В25 П4">В25 П4</option>-->
                        <!--                      <option value="В30 П4">В30 П4</option>-->
                        <!--                      <option value="В7,5 Ж4">В7,5 Ж4</option>-->
                        <!--                      <option value="В12,5 Ж4">В12,5 Ж4</option>-->
                        <!--                      <option value="В15 Ж4">В15 Ж4</option>-->
                        <!--                      <option value="В20 Ж4">В20 Ж4</option>-->
