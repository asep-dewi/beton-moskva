...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?> бетон в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область по низким ценам, круглосуточно - <?= $content['brand'] ?></title>
  ...
  <div class="wrap">
    ...
    <section class="title deli-block" style="background-image: url(/img/title_delivery.jpg);">
      <div class="container">
        ...
        <h1><?= $content['service'][$_SESSION['service']]['service_1'] ?> бетон в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?></h1>
        <div class="row">
          <div class="col-md-6">
    ...
    <section class="cards-b margin-bottom-b">
      <div class="container">
        <h2 class="cards-b">Цены на <?= $content['service'][$_SESSION['service']]['service_2'] ?> бетон</h2>
        <div class="cards-b__wrapper">


          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B7.5B100']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B7.5B100']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B7.5B100']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B7.5B100']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B12.5M150']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B12.5M150']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B12.5M150']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B12.5M150']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B15M200']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B15M200']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B15M200']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B15M200']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B20M250']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B20M250']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B20M250']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B20M250']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B22.5M300']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B22.5M300']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B22.5M300']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B22.5M300']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B25M350']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['graviy']['B25M350']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['granit']['B25M350']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гранит)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B25M350']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          ...
          <div class="cards-b__box">
            <div class="cards-b__item">
              <div class="cards-b__name"><?= $content['beton_price']['graviy']['B30M400']['name'] ?></div>
              <div class="cards-b__title">Тяжелый бетон (гравий)</div>
              <div class="cards-b__price"><span>Цена: </span><span><?= $content['beton_price']['granit']['B30M400']['price'] ?> р./м³</span></div>
              <a href="#callback-modal" class="popup-modal cards-b__button" data-title="Заказать бетон" tabindex="0">Заказать</a>
            </div>
          </div>
          <div class="cards-b__box">
        ...
        <a class="cards-b__link" href="/цены/">Посмотреть все цены</a>
      </div>
    </section>
    ...
    <section class="block zakaz-beton-block zakaz-beton-block-dostavka">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="mb10">Закажите <?= $content['service'][$_SESSION['service']]['service_2'] ?> бетон с доставкой прямо сейчас!</h2>
          </div>
