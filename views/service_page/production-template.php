...
<head>
  ...
  <title>Производство и доставка бетона в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?> дешево, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область недорого, круглосуточно - <?= $content['brand'] ?></title>
