...
<head>
  ...
  <title><?= $content['service'][$_SESSION['service']]['service_1'] ?> на бетон в <?= $content['domens'][$_SESSION['domen']]['gorod_predl_p'] ?>, низкие цены на услуги 👍. Заказать бетон в Мск и Московская область недорого, круглосуточно - <?= $content['brand'] ?></title>
